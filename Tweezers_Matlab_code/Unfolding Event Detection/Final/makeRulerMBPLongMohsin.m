...
T = 293.15; %K
Ld = 2*2666*0.34*1E-9;%700.1E-9;%920E-9; %nm %500 basepairs for both dual DNA handles
Lp = 120E-9;%10E-9;%120E-9;%370*0.%120E-9; %nm
pP = 1.5E-9; %nm
pD = 45E-9; %nm
K = 1.2E-9;
P = pD;
...
L =  120E-9;%140*0.36E-9;%120*10^(-9);    % Ruud thesis: 120 nm  i.e. 0.33 per aa and 370 aa  / other references I have seen that people use 0.36 per aa 
