function [ ] = drawTweezersWindow( ) %#ok<STOUT,INUSD>
...
colors      =   linspecer(8);
set(f,'BackingStore','off','MenuBar','figure','NumberTitle','off','Name',['Tweezers Analysis Software ' datVr.ver],'Color','g');
...
I=imread('BackgroundImageTweezers.jpg');
hi = imagesc(I);
colormap gray;
...
set(0,'Currentfigure',f)
wndVr.hpc  = uicontrol('Style','text','Position',[0.2 0.92 0.6 height+0.01],'String',['Tweezers Analysis Software ' datVr.ver],...
    'FontSize',titlefs+0.2,'ForegroundColor',colors(5,:),'BackgroundColor',colors(2,:));
set(0,'Currentfigure',f)
...
uicontrol('Style','Pushbutton', ...
    'Position',[left1 0.92 0.5*(wid1+wid2)+edge height], ...
    'String','Calibration',...
...
uicontrol('Style','Pushbutton', ...
    ...
    'BackgroundColor',colors(2,:),...
    'ForegroundColor',colors(5,:),...
    'Callback','prgVr.setupStt = 1; save([pwd filesep ''progState.mat''],''prgVr'',''-append''); drawFoldometerWindow;');
set(0,'Currentfigure',f)
wndVr.legendBut = uicontrol('Style','Pushbutton', ...
    'Position',[1-0.5*(wid1+wid2)-edge*4 bbot1+(bbot2-bbot1)/3 0.5*(wid1+wid2)+edge height], ...
    'String','Legend ON',...
    'FontSize',titlefs+0.2,...
    'BackgroundColor',colors(2,:),...
    'ForegroundColor',colors(5,:),...
...
wndVr.resetAxBut = uicontrol('Style','Pushbutton', ...
    'Position',[1-1*(wid1+wid2)-edge*6 bbot1+(bbot2-bbot1)/3 0.5*(wid1+wid2)+edge height], ...
    'String','Reset Axis',...
    'FontSize',titlefs+0.2,...
    'BackgroundColor',colors(2,:),...
    'ForegroundColor',colors(5,:),...
    'Callback','if ~isempty(data); pltVr.rstAx = 1; if pltVr.grphAct == 1; data = plotFT(); elseif pltVr.grphAct == 2; data = plotTE(); elseif pltVr.grphAct == 3; data = plotFECombined(); elseif pltVr.grphAct == 4; data = plotS(); end; set(wndVr.sampling_xlim,''String'',num2str(get(gca,''xlim''))); set(wndVr.sampling_ylim,''String'',num2str(get(gca,''ylim''))); end;');
set(0,'Currentfigure',f)
wndVr.unfBut = uicontrol('Style','Pushbutton', ...
    'Position',[1-1.5*(wid1+wid2)-edge*8 bbot1+(bbot2-bbot1)/3 0.5*(wid1+wid2)+edge height], ...
...
wndVr.WLCBut = uicontrol('Style','Pushbutton', ...
    'Position',[1-2*(wid1+wid2)-edge*10 bbot1+(bbot2-bbot1)/3 0.5*(wid1+wid2)+edge height], ...
    'String','WLC Fit OFF',...
    'FontSize',titlefs+0.2,...
    'BackgroundColor',colors(2,:),...
    'ForegroundColor',colors(5,:),...
...
wndVr.contourPlotBut = uicontrol('Style','Pushbutton', ...
    'Position',[1-0.15*(wid1+wid2)-edge*4 bbot3+2*edge 0.15*(wid1+wid2)+edge height], ...
    'String','Plot Lp OFF',...
...
uicontrol('Style','Pushbutton', ...
    ...
    'BackgroundColor',colors(2,:),...
    'ForegroundColor',colors(5,:),...
    'Callback','data = getRaw(); if(~isstruct(data)) data = []; else pltVr.rstAx = 1; pltVr.ftAx = []; pltVr.teAx = []; pltVr.feAx = [0.5 1.5 -10  85]; pltVr.ssAx = []; data = plotFECombined(); data = plotFT(); set(wndVr.sampling_xlim,''String'',num2str(get(gca,''xlim''))); set(wndVr.sampling_ylim,''String'',num2str(get(gca,''ylim''))); wndVr.hTrig = 0; wndVr.vTrig = 0; set(wndVr.sampling_for,''String'',num2str(data.kx)); end;');
set(0,'Currentfigure',f)
uicontrol('Style','Pushbutton', ...
    ...
    %'Callback','if ~isempty(data) data = getProc(data); else data = getProc; end; if(~isstruct(data)) data = []; else pltVr.rstAx = 1; pltVr.ftAx = []; pltVr.teAx = []; pltVr.feAx = [0.5 1.5 -10  85]; pltVr.ssAx = []; data = plotFECombined(data); data = plotFT(data); set(wndVr.sampling_xlim,''String'',num2str(get(gca,''xlim''))); set(wndVr.sampling_ylim,''String'',num2str(get(gca,''ylim''))); wndVr.hTrig = 0; wndVr.vTrig = 0; set(wndVr.sampling_for,''String'',num2str(data.kx)); end;');
set(0,'Currentfigure',f)
uicontrol('Style','Pushbutton', ...
    ...
    'BackgroundColor',colors(2,:),...
    'ForegroundColor',colors(5,:),...
    'Callback','if ~isempty(data) saveData(data); end;');
set(0,'Currentfigure',f)
uicontrol('Style','Pushbutton', ...
...
uicontrol('Style','Pushbutton', ...
    ...
    'BackgroundColor',colors(2,:),...
    'ForegroundColor',colors(5,:),...
    'Callback','if ~isempty(data) data = plotS(); set(wndVr.sampling_xlim,''String'',num2str(get(gca,''xlim''))); set(wndVr.sampling_ylim,''String'',num2str(get(gca,''ylim''))); end;');
set(0,'Currentfigure',f)
uicontrol('Style','Pushbutton', ...
...
set(0,'Currentfigure',f)
wndVr.sampling_for = uicontrol('Style','edit', ...
    'Units','normalized', ...
    'Position',[left2-0.5*edge bbot9 1*(wid2)+0.5*edge height], ...
    'String',num2str(0),...   
    'BackgroundColor',color2,...
    'Callback','if(length(str2num(get(wndVr.sampling_for,''String''))) == 1 && ~isempty(data)) datVr.forVal = max(1,str2num(get(wndVr.sampling_for,''String''))); data.kx = max(1,str2num(get(wndVr.sampling_for,''String''))); data = plotFECombined(); end;');
set(0,'Currentfigure',f)
...
wndVr.sampling_sens = uicontrol('Style','edit', ...
    ...
    'BackgroundColor',color2,...
    'Callback','if(length(str2num(get(wndVr.sampling_sens,''String''))) == 1 && ~isempty(data)) pltVr.fitVal = max(1,str2num(get(wndVr.sampling_sens,''String''))); data.dvdx = max(1,str2num(get(wndVr.sampling_sens,''String''))); data = plotFECombined(); elseif(length(str2num(get(wndVr.sampling_sens,''String''))) == 2 && ~isempty(data) && strcmp(get(wndVr.sensBut,''String''),''Sensitivity Fit'')) pltVr.fitVal = str2num(get(wndVr.sampling_sens,''String'')); pltVr.fitVal(1) = min(max(0, min(pltVr.fitVal(1),pltVr.fitVal(2))),1); pltVr.fitVal(2) = min(max(0, max(pltVr.fitVal(1),pltVr.fitVal(2))),1); if(pltVr.fitVal(2) == 0) pltVr.fitVal(2) = 1; end; set(wndVr.sampling_sens,''String'',num2str(pltVr.fitVal)); data = plotS(); end;');
...
wndVr.hruler  = uicontrol('Style','popup', ...
    ...
    'BackgroundColor',color1,'Value',2);
set(0,'Currentfigure',f)
wndVr.hsignal  = uicontrol('Style','popup', ...
    'Position',[left2-0.5*edge bbot11+0.25*height 1*(wid1)+0.5*edge height], ...
    'String',' Piezo Signal | Camera Signal | Combined Signal', ...
    'Callback','datVr.sigVal = get(wndVr.hsignal, ''Value''); if ~isempty(data) data = plotFECombined(); end;', ...
    'BackgroundColor',color1,'Value',1);
set(0,'Currentfigure',f)
wndVr.hSlider = uicontrol('Style','slider','Position',[0.335,0.05-edge*3,0.64,0.01+edge*(0.65/(0.85+edge*3))],'callback','if ~isempty(data) if(wndVr.hTrig == 0) wndVr.hTrig = 1; data = plotFECombined(); maxTemp = max(cellfun(@(x)max(x(:)), data.scombined)); minTemp = min(cellfun(@(x)min(x(:)), data.scombined)); set(wndVr.hSlider, ''Min'', min(1*(0-maxTemp), 1*(0-minTemp)), ''Value'', mean([min(1*(0-maxTemp)+0.9, 1*(0-minTemp)+0.9) max(1*(0-minTemp)+0.9, 1*(0-maxTemp)+0.9)]), ''Max'', max(1*(0-minTemp)+0.9, 1*(0-maxTemp)+0.9), ''SliderStep'', abs([1 1].*((1*(0-maxTemp))-(1*(0-minTemp)))./1000)); end; data.shiftX = get(wndVr.hSlider,''Value''); set(wndVr.sampling_shift,''String'', num2str([data.shiftX data.shiftY])); data = plotFECombined(); end;');%,'Callback', @(s,e) disp(get(s,'Value')));%'Min',-3,'Max',3,...
set(0,'Currentfigure',f)
wndVr.vSlider = uicontrol('Style','slider','Position',[0.325,0.05-edge*3,0.01,0.85+edge*3],'callback','if ~isempty(data) if(wndVr.vTrig == 0) wndVr.vTrig = 1; data = plotFECombined(); maxTemp = max(cellfun(@(x)max(x(:)), data.force)); minTemp = min(cellfun(@(x)min(x(:)), data.force)); set(wndVr.vSlider, ''Min'', min(1*(0-maxTemp)-0.9, 1*(0-minTemp)-0.9), ''Value'', max([min(1*(0-maxTemp), 1*(0-minTemp)) max(1*(0-minTemp), 1*(0-maxTemp))]), ''Max'', max(1*(0-minTemp)+0.9, 1*(0-maxTemp)+0.9), ''SliderStep'', abs([1 1].*((1*(0-maxTemp))-(1*(0-minTemp)))./1000)); end; data.shiftY = get(wndVr.vSlider,''Value''); set(wndVr.sampling_shift,''String'', num2str([data.shiftX data.shiftY]));  data = plotFECombined(); end;');
set(0,'Currentfigure',f)
