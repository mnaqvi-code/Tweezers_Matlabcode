...
elseif strcmp(ConvertedData.Data.Root.Property(2).Value{1},'6')
    ...
    cFSplit = strsplit(ConvertedData.Data.MeasuredData(2).Property(8).Value,'|');
    
    %Fit Parameters Trap 1 - X
    datVr.dualCst.cFreq1 = ConvertedData.Data.MeasuredData(5).Property(3).Value; %Hz
    ...
    datVr.dualCst.alpha1 = ConvertedData.Data.MeasuredData(5).Property(1).Value./ConvertedData.Data.MeasuredData(5).Property(4).Value.*1E6; %um/a.u.
    datVr.dualCst.Dex1 =  datVr.dualCst.Dth1./(datVr.dualCst.alpha1./10^6).^2;
    
    %Fit Parameters Trap 1 - Y
    datVr.dualCst.cFreq3 = ConvertedData.Data.MeasuredData(6).Property(3).Value; %Hz
    ...
    datVr.dualCst.alpha3 = ConvertedData.Data.MeasuredData(6).Property(1).Value./ConvertedData.Data.MeasuredData(6).Property(4).Value.*1E6; %um/a.u.
    datVr.dualCst.Dex3 =  datVr.dualCst.Dth3./(datVr.dualCst.alpha3./10^6).^2;
    
    %Fit Parameters Trap 2 - X
    
    datVr.dualCst.cFreq2 = ConvertedData.Data.MeasuredData(7).Property(3).Value; %Hz
    ...
    datVr.dualCst.alpha2 = ConvertedData.Data.MeasuredData(7).Property(1).Value./ConvertedData.Data.MeasuredData(7).Property(4).Value.*1E6; %um/a.u.
    datVr.dualCst.Dex2 =  datVr.dualCst.Dth2./(datVr.dualCst.alpha2./10^6).^2;
    
    %Fit Parameters Trap 2 - Y
    
    datVr.dualCst.cFreq4 = ConvertedData.Data.MeasuredData(8).Property(3).Value; %Hz
    ...
    datVr.dualCst.alpha4 = ConvertedData.Data.MeasuredData(8).Property(1).Value./ConvertedData.Data.MeasuredData(8).Property(4).Value.*1E6; %um/a.u.
