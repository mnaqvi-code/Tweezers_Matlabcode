function [ ] = drawCTrapWindow( ) %#ok<STOUT,INUSD>
%UNTITLED3 Summary of this function goes here
%   Detailed explanation goes here
global binaryD data fluodata f pltVr datVr prgVr wndVr; %#ok<NUSED>
...
colors      =   linspecer(8);
set(f,'BackingStore','off','MenuBar','figure','NumberTitle','off','Name',['Ctrap Analysis Software ' datVr.ver],'Color','g');
...
set(0,'Currentfigure',f)
wndVr.hpc  = uicontrol('Style','text','Position',[0.2 0.92 0.6 height+0.01],'String',['Ctrap Analysis Software ' datVr.ver],...
...
uicontrol('Style','Pushbutton', ...
    ...
    'BackgroundColor',color1,...
    'ForegroundColor',color3,...
    'Callback','prgVr.setupStt = 0; save([pwd filesep ''progState.mat''],''prgVr'',''-append''); drawTweezersWindow;');
set(0,'Currentfigure',f)
...
uicontrol('Style','Pushbutton', ...
    ...
    'BackgroundColor',color1,...
    'ForegroundColor',color3,...
    'Callback','data = getCTrapData(); if(~isstruct(data)) data = []; elseif(strcmp(data.Data.Root.Property(2).Value{1},''5'') || strcmp(data.Data.Root.Property(2).Value{1},''6'')) data.filename = data.FileName; pltVr.rstAx = 1; pltVr.ftAx = []; pltVr.teAx = []; pltVr.feAx = [0.5 1.5 -10  85]; pltVr.ssAx = []; data = plotFECombined(); data = plotFT(); set(wndVr.sampling_xlim,''String'',num2str(get(gca,''xlim''))); set(wndVr.sampling_ylim,''String'',num2str(get(gca,''ylim''))); wndVr.hTrig = 0; wndVr.vTrig = 0; end;');
set(0,'Currentfigure',f)
uicontrol('Style','Pushbutton', ...
...
uicontrol('Style','Pushbutton', ...
    ...
    'BackgroundColor',color1,...
    'ForegroundColor',color3,...
    'Callback','if ~isempty(data) data = plotFECombined(); end;'); %set(wndVr.sampling_xlim,''String'',num2str(get(gca,''xlim''))); set(wndVr.sampling_ylim,''String'',num2str(get(gca,''ylim''))); set(wndVr.sampling_shift,''String'',num2str([data.shiftX data.shiftY]));
set(0,'Currentfigure',f)
uicontrol('Style','Pushbutton', ...
...
wndVr.sensBut = uicontrol('Style','Pushbutton', ...
    ...
    'String','Scanary Data (*.tdms)',...
    'FontSize',titlefs+0.2,...
    'BackgroundColor',color1,...
    'ForegroundColor',color3,...
    'Callback','if ~isempty(data) fluodata = getScanaryData(); if(~isstruct(fluodata)) fluodata = []; elseif(strcmp(data.Data.Root.Property(2).Value{1},''Scanary1'')) fluodata.filename = fluodata.FileName; end; end;');
set(0,'Currentfigure',f)
wndVr.sampling_sens = uicontrol('Style','Pushbutton', ...
    'Position',[left2-0.5*edge bbot10 1*(wid2)+0.5*edge height], ...
    'String','Plot Scanary',...
    'FontSize',titlefs+0.2,...
    'BackgroundColor',color1,...
    'ForegroundColor',color3,...
    'Callback','if ~isempty(fluodata) plotFluo; end');
...
wndVr.hsignal  = uicontrol('Style','Pushbutton', ...
    ...
    'BackgroundColor',color1,...
    'ForegroundColor',color3,...
    'Callback','if ~isempty(data) loadRuler; data = plotFECombined(); end;');
set(0,'Currentfigure',f)
...
wndVr.sampling_pol = uicontrol('Style','edit', ...
    ...
    'String',num2str(datVr.decFact),...
    'BackgroundColor',color2,...
    'Callback','if(length(str2num(get(wndVr.sampling_pol,''String''))) == 1) && ~isempty(data) datVr.decFact = min(max(str2num([get(wndVr.sampling_pol,''String'')]),1),1000); set(wndVr.sampling_pol,''String'', num2str(datVr.decFact)); data.x = []; data = plotFECombined(); end;');
set(0,'Currentfigure',f)
